          ...
          <div class="row">
              <div class="col-xl-12">
                  <div class="bradcam_text">
                      ...
                      <p><a href="index.html">Home /</a> Detail Potensi</p>
                  </div>
              </div>
          </div>
      </div>
            ...
            <div class="col-lg-12 posts-list">
               <div class="single-post">
                  <div class="feature-img">
                     <img class="img-fluid" src="{{ asset('foto/'.$potensi->foto) }}" alt="{{ $potensi->nama_potensi }}" width="100%" height="375">
                  </div>
                  <div class="blog_details">
                     <h2> {{ $potensi->nama_potensi }} </h2>
                     <ul class="blog-info-link mt-3 mb-4">
                        <li><a href="#"><i class="fa fa-map"></i>{{ $potensi->alamat }}</a></li>
                     </ul>
                     <p class="excert">
                     {!! nl2br(e($potensi->keterangan)) !!}
                     </p>
