                    ...
                    <!-- <div class="row"> -->
                        ...
                        <!-- <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> {{ $xasi ?? '' }}</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i> {{ $xasi ?? '' }}</a></li>
                                </ul>
                            </div>
                        </div> -->
                    <!-- </div> -->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-5 col-lg-5">
                            <div class="logo">
                                <a href="{{ url('/') }}">
                                    <img src="{{ asset('foto/'.($xasi->logo ?? 'logo-soppeng.png')) }}" width="50" class="img-responsive">
                                </a>
                            </div>
                        </div>
                                    ...
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">Tentang Desa<i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="{{ url('/galerys') }}">Budaya</a></li>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img  src="{{ asset('foto/'.($xasi->logo ?? 'logo-soppeng.png')) }}" width="50">
                                </a>
                            </div>
                            <p>
                                Mediasosial Kami
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p>
                            Kec. Marioriawa, Kabupaten Soppeng, Sulawesi Selatan, Indonesia
                            </p>
                        </div>
                    </div>
                </div>
